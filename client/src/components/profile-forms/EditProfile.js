...
const EditProfile = ({getCurrentProfile, createProfile, deleteUser, profile:{profile, loading, isUpdated},auth}) => {
                        ...
                        <form encType="multipart/form-data" onSubmit={e=>onSubmit(e)}>
                            <div className="profileHeader">
                                ...
                                <div className="upload-image row">
                                    <div className="form-group col-3">
                                        <label htmlFor="image" className="label rounded-circle" style={{ backgroundImage: "url("+avatar+")", backgroundSize: "cover", backgroundPosition: "center"}}>
                            ...
                            <div className="mainInfoProfile">
                                ...
                                <div className="gender-form form-group row">
                                    <p className="col-sm-3 col-form-label"><i className="fas fa-venus-mars"></i> Gender</p>
                                ...
                                {displayLinks && <Fragment>
                                    <div className="form-group row">
                                        <label htmlFor="instagram" className="col-sm-3 col-form-label"><i className="fab fa-instagram"></i>  Instagram</label>
                                        <input
                                            type="text"
                                            className="form-control  col-sm-9"
                                            name="instagram"
                                    ...
                                    <div className="form-group row">
                                        <label htmlFor="facebook" className="col-sm-3 col-form-label"><i className="fab fa-facebook-f"></i>  Facebook</label>
                                        <input
                                            className="form-control  col-sm-9"
                                            name="facebook"
                                            id="facebook"
                                    ...
                                    <div className="form-group row">
                                        <label htmlFor="vk" className="col-sm-3 col-form-label"><i className="fab fa-vk"></i>  Vk</label>
                                        <input
                                            className="form-control  col-sm-9"
                                            name="vk"
                                            id="vk"
                                    ...
                                    <div className="form-group row"><label htmlFor="pinterest" className="col-sm-3 col-form-label"><i className="fab fa-pinterest-p"></i>  Pinterest</label>
                                        <input
                                            className="form-control col-sm-9"
                                            name="pinterest"
                                            id="pinterest"
...
export default connect(mapStateToProps,{getCurrentProfile, createProfile, deleteUser})(EditProfile)
