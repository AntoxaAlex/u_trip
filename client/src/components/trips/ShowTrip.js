...
import {getTripById, createComment, createReply} from "../../actions/trips";
...
const ShowTrip = ({getTripById, createComment, createReply, addLike, trips:{trip, loading}, profile:{profile}, profileLoading, user}) => {
                    ...
                    <div id="desc_rate_row" className="row">
                        ...
                        <div className="col-6">
                            <div id="ratingDiv" className="float-right text-warning">
                                <input type="radio" id="fieldStar5" name="rating" value="5"/><label className="full" htmlFor="fieldStar5"/>
                                <input type="radio" id="fieldStar4" name="rating" value="4"/><label className="full" htmlFor="fieldStar4"/>
                                <input type="radio" id="fieldStar3" name="rating" value="3"/><label className="full" htmlFor="fieldStar3"/>
                                <input type="radio" id="fieldStar2" name="rating" value="2"/><label className="full" htmlFor="fieldStar2"/>
                                <input type="radio" id="fieldStar1" name="rating" value="1"/><label className="full" htmlFor="fieldStar1"/>
                            </div>
                        </div>
                    </div>
                    <hr/>
...
export default connect(mapStateToProps,{getTripById, createComment, createReply, addLike})(ShowTrip);